...
;; accept. For example:
;;
(setq doom-font (font-spec :family "JetBrainsMono NF" :size 32 :weight 'regular))
(set-fontset-font "fontset-default" 'hangul (font-spec :family "NanumGothicCoding" :size 32))
;;
